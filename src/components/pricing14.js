        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text172 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <p>
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text157 thq-body-large">
                          $199.99
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text190 thq-heading-3">
                          $29.99
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <h3>
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text158 thq-heading-3">
                          $200/yr
                        </h3>
                      </Fragment>
                    )}
