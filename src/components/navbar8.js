                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text15 thq-body-small">
                                  Bienvenida a la sorpresa de las flores
                                  amarillas
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text22 thq-body-small">
                                  ¿Quieres decir algo? ¡Déjame un mensaje!
                                </span>
                              </Fragment>
                            )}
                          </span>
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span>
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text15 thq-body-small">
                            Bienvenida a la sorpresa de las flores amarillas
                          </span>
                        </Fragment>
                      )}
                    </span>
...
Navbar8.defaultProps = {
  ...
  page3: undefined,
  page4ImageAlt: 'Contacto',
  page2: undefined,
  page3ImageAlt: 'Mensaje',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1712949111066-71dfb05f8bc5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjkzNDcxMnw&ixlib=rb-4.0.3&q=80&w=1080',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1634718669030-b80bcf4e7e5b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjkzNDcxMXw&ixlib=rb-4.0.3&q=80&w=1080',
  page3Description: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1657322932513-3004566edded?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjkzNDcxMnw&ixlib=rb-4.0.3&q=80&w=1080',
  link1: undefined,
  page4: undefined,
  page1ImageAlt: 'Flores amarillas',
  ...
  logoAlt: 'Flores Amarillas',
  linkUrlPage1: 'https://www.teleporthq.io',
  linkUrlPage4: 'https://www.teleporthq.io',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1529101091764-c3526daf38fe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjkzNDcxMXw&ixlib=rb-4.0.3&q=80&w=1080',
  link3: undefined,
